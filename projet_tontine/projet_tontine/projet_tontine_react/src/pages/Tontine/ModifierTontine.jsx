...
const ModifierTontine = () => {
    ...
    const handleFormSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`http://localhost:8085/Tontines/UpdateTontineById/${idU}`,tontineData);
    ...
    useEffect(() => {
        if (!id) {
          ...
          const fetchData = async () => {
            try {
              const response = await axios.get(`http://localhost:8085/Tontines/GetTontineById/${idU}`);
             ...
             setTontineData({
                    libelle: tontinesData.libelle || "",
                    description: tontinesData.description || "",
                    montantTotal: tontinesData.montantTotal || "",
                    nbrParticipants: tontinesData.nbrParticipants || "",
                    periode: tontinesData.periode || "",
                });
...
return(
  ...
  <div>
    <div class="mb-3">
      <label class="" htmlFor="inputUsername">Libelle tontine</label>
      <input
        class="form-control"
        name="libelle"
        id="libelle"
        type="text"
        defaultValue={tontines.libelle}
    ...
    <div class="mb-3">
      <label class="" htmlFor="inputFirstName">Description</label>
      <textarea
        class="form-control"
        name="description"
        id="description"
        type="text"
        defaultValue={tontines.description}
    ...
    <div class="row gx-3 mb-3">
      <div class="col-md-6">
        <label class="" htmlFor="inputLastName">Montant total</label>
        <input
          class="form-control"
          id="montantTotal"
          name="montantTotal"
          type="number"
          defaultValue={tontines.montantTotal}
          placeholder="Entrer le montant total"
          onChange={handleInputChange}
        />
      </div>
      <div class="col-md-6">
        <label class="" htmlFor="inputOrgName">Nombre participants</label>
        <input
          class="form-control"
          id="nbrParticipants"
          name="nbrParticipants"
          type="number"
          defaultValue={tontines.nbrParticipants}
          placeholder="Entrer nombre des participants"
          onChange={handleInputChange}
        />
      </div>
    </div>
    ...
    <div class="row gx-3 mb-3">
      <div class="col-md-6">
        <label class="" htmlFor="inputLocation">Période</label>
        <input
          class="form-control"
          id="periode"
          name="periode"
          type="number"
          defaultValue={tontines.periode}
          placeholder="Enter la duree de cette tontine"
          onChange={handleInputChange}
        />
      </div>
    </div>
...
export default  ModifierTontine;